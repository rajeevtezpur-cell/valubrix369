// SellDiscoverPage.tsx — Prime Exit (Sell) multi-step discover flow
...
const PAGE_TITLE = "Prime Exit";
const PAGE_SUBTITLE = "Sell";
const ACCENT = "#D8B56A";
const NAVY = "#071A2F";

export default function SellDiscoverPage() {
  ...
  function handleAreaNext(data: BudgetOrAreaData) {
  ...
  function handleFiltersNext(data: AdditionalFiltersData) {
    ...
    // Show overlay before revealing results
    setShowOverlay(true);
  }
    ...
    >
      ...
      >
        <button
          ...
          data-ocid="sell_discover.home_link"
        ...
        <button
          ...
          data-ocid="sell_discover.back_button"
          style={{
            background: "none",
            border: "none",
            cursor: "pointer",
      ...
      <main className="flex-1 flex flex-col items-center px-4 py-6 md:px-8 md:py-10">
        <div className="w-full max-w-xl">
          ...
          >
            ...
            {step === 3 && (
              /* Fix 3: Area mode now collects area type in BudgetOrAreaStep */
              <BudgetOrAreaStep
                mode="area"
            ...
            {step === 4 && (
              /* Fix 3: hideAreaFields=true — area type already in step 3 */
